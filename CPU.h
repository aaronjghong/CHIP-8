...
// Implementation
// The file did not compile properly with a seperate .cpp file to hold the definitions of the functions
// The declarations will be temporarily here in the header file until the issue is solved
